...
- 不定期: 石垣島マーケットイベント（ユーグレナモール周辺）(0.08) ※「ゆいまーる市場」開催日は不定のため、noteには「最新情報は石垣島イベント情報Facebookグループで確認を」と記載
- 毎日: 沖縄民謡・三線ライブ居酒屋（結風・あぐー家・祭歌・うさぎや等の三線居酒屋。毎晩2ステージ 19:00〜・21:00〜）(0.08) ※「フルスト原遺跡近くのバー等」という誤った会場名は絶対使わないこと
- 毎日（2〜11月）: 星空観察ツアー（のばれ岬・川平湾周辺。日本初の星空保護区。複数社が毎日催行）(0.10) ※「毎月1〜2回」は誤りのため使わないこと
- 通年毎日: 青の洞窟・川平湾シュノーケル＆体験ダイビングツアー（青の洞窟・川平湾・マンタスクランブル。マンタは3〜11月が遭遇率高め）(0.08)
